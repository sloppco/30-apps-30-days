...
export const apps: App[] = [
  ...
  },
  {
    ...
    description:
      "Pick a coaching style, describe your decision, answer follow-up questions, and get a streamed AI breakdown tailored to your style.",
    stack: "Next.js 16, Tailwind, Anthropic SDK",
    liveUrl: "https://day05.slopp.co",
    githubPath: "apps/day-05-decision-helper",
    timeToShip: "",
    reflection: "",
  },
  {
    ...
    description:
      "Paste API code, an OpenAPI spec, or plain English — get clean, Stripe-style rendered documentation with endpoint cards, method badges, param tables, and syntax-highlighted code blocks.",
    stack: "Next.js 16, Tailwind, Anthropic SDK",
    liveUrl: "https://day06.slopp.co",
    githubPath: "apps/day-06-api-docs-generator",
    timeToShip: "",
    reflection: "",
  },
